...
TEST(OSGEOSYSTEM, GetKeyFromlongitudelatitudeAtDepthToBounds) {
  ...
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(-180.0), Latitude(+85.05113877)),
      0);
  ...
  EXPECT_TRUE(bbox.lower_left().near(
      GeoCoordinate2d(Longitude(-180.0), Latitude(-85.05113877)), 1e-4))
      << "Actual = " << bbox.lower_left() << " for " << qk;
  EXPECT_TRUE(bbox.upper_right().near(
      GeoCoordinate2d(Longitude(+180.0), Latitude(+85.05113877)), 1e-4))
      << "Actual = " << bbox.upper_right() << " for " << qk;

  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+0.0), Latitude(+0.00000000)), 0);
  EXPECT_EQ(QuadKey(Type::OsGeo, 0, 0, 0), qk);
  ...
  qk.get_geo_coordinate_bounds2d(bbox);
  EXPECT_TRUE(bbox.lower_left().near(
      GeoCoordinate2d(Longitude(-180.0), Latitude(+0.00000000)), 1e-4))
      << "Actual = " << bbox.lower_left() << " for " << qk;
  EXPECT_TRUE(bbox.upper_right().near(
      GeoCoordinate2d(Longitude(+0.0), Latitude(+85.05113877)), 1e-4))
      << "Actual = " << bbox.upper_right() << " for " << qk;
  ...
  qk.get_geo_coordinate_bounds2d(bbox);
  EXPECT_TRUE(bbox.lower_left().near(
      GeoCoordinate2d(Longitude(+0.0), Latitude(+0.00000000)), 1e-4))
      << "Actual = " << bbox.lower_left() << " for " << qk;
  EXPECT_TRUE(bbox.upper_right().near(
      GeoCoordinate2d(Longitude(+180.0), Latitude(+85.05113877)), 1e-4))
      << "Actual = " << bbox.upper_right() << " for " << qk;
  ...
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(-180.0), Latitude(+0.00000000)),
      1);
  EXPECT_EQ(QuadKey(Type::OsGeo, 0, 0, 1), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+0.0), Latitude(+85.05113877)), 1);
  EXPECT_EQ(QuadKey(Type::OsGeo, 1, 0, 1), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+180.0), Latitude(+0.00000000)),
      1);
  ...
  EXPECT_EQ(QuadKey(Type::OsGeo, 0, 0, 1), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+0.0), Latitude(+0.00000000)), 1);
  EXPECT_EQ(QuadKey(Type::OsGeo, 0, 0, 1), qk);
  ...
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(-180.0), Latitude(-66.5133)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 0, 0, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(-180.0), Latitude(-66.5132)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 1, 0, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(-180.0), Latitude(+0.1)), 2);
  ...
  EXPECT_EQ(QuadKey(Type::OsGeo, 3, 0, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(-90.0), Latitude(-85.05113877)),
      2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 0, 0, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(-90.0), Latitude(-66.5133)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 0, 0, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(-90.0), Latitude(-66.5132)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 1, 0, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(-90.0), Latitude(+0.1)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 2, 0, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(-90.0), Latitude(+66.5132)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 2, 0, 2), qk);
  ...
  EXPECT_EQ(QuadKey(Type::OsGeo, 3, 0, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(-89.9), Latitude(-85.05113877)),
      2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 0, 1, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(-89.9), Latitude(-66.5133)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 0, 1, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(-89.9), Latitude(-66.5132)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 1, 1, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(-89.9), Latitude(+0.1)), 2);
  ...
  EXPECT_EQ(QuadKey(Type::OsGeo, 3, 1, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+0.0), Latitude(-85.05113877)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 0, 1, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+0.0), Latitude(-66.5133)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 0, 1, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+0.0), Latitude(-66.5132)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 1, 1, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+0.0), Latitude(+0.1)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 2, 1, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+0.0), Latitude(+66.5132)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 2, 1, 2), qk);
  ...
  EXPECT_EQ(QuadKey(Type::OsGeo, 3, 1, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+0.1), Latitude(-85.05113877)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 0, 2, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+0.1), Latitude(-66.5133)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 0, 2, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+0.1), Latitude(-66.5132)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 1, 2, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+0.1), Latitude(+0.1)), 2);
  ...
  EXPECT_EQ(QuadKey(Type::OsGeo, 3, 2, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+90.1), Latitude(-85.05113877)),
      2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 0, 3, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+90.1), Latitude(-66.5133)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 0, 3, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+90.1), Latitude(-66.5132)), 2);
  EXPECT_EQ(QuadKey(Type::OsGeo, 1, 3, 2), qk);
  qk = QuadKey::get_key_from_longitude_latitude_at_depth(
      Type::OsGeo, GeoCoordinate2d(Longitude(+90.1), Latitude(+0.1)), 2);
...
TEST(OSGEOSYSTEM, get_keys_from_longitude_latitude_bounding_box) {
  ...
  EXPECT_NE(std::find(qks.begin(), qks.end(), QuadKey(Type::OsGeo, 0, 0, 0)),
            qks.end());
  ...
  EXPECT_NE(std::find(qks.begin(), qks.end(), QuadKey(Type::OsGeo, 0, 0, 1)),
            qks.end());
  EXPECT_NE(std::find(qks.begin(), qks.end(), QuadKey(Type::OsGeo, 0, 1, 1)),
            qks.end());
  EXPECT_NE(std::find(qks.begin(), qks.end(), QuadKey(Type::OsGeo, 1, 0, 1)),
            qks.end());
  EXPECT_NE(std::find(qks.begin(), qks.end(), QuadKey(Type::OsGeo, 1, 1, 1)),
            qks.end());
