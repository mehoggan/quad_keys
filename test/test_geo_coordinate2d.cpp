...
TEST(GEOCOORDINATE2D, near) {
...

  {
    ...
    EXPECT_TRUE(
        coord.near(GeoCoordinate2d(Longitude(0.0009), Latitude(0.0009)), 1e-3));
  }

  {
    GeoCoordinate2d coord(Longitude(0.001), Latitude(0.001));
    EXPECT_FALSE(
        coord.near(GeoCoordinate2d(Longitude(0.001), Latitude(0.0009)), 1e-4));
  }

  {
    GeoCoordinate2d coord(Longitude(0.001), Latitude(0.001));
    EXPECT_FALSE(
        coord.near(GeoCoordinate2d(Longitude(0.0009), Latitude(0.001)), 1e-4));
  }
}
