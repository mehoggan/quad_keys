...
TEST(GEOCOORDINATEBOUNDINGBOX2D, default_ctor) {
  ...
  ASSERT_FALSE(empty.contains(GeoCoordinate2d(Longitude(0.0), Latitude(0.0))));
}
...
TEST(GEOCOORDINATEBOUNDINGBOX2D, contains_or_not) {
  {
    ...
    EXPECT_TRUE(
        geo_box.contains(GeoCoordinate2d(Longitude(0.0), Latitude(0.0))));

    EXPECT_TRUE(
        geo_box.contains(GeoCoordinate2d(Longitude(90.0), Latitude(45.0))));
    EXPECT_TRUE(
        geo_box.contains(GeoCoordinate2d(Longitude(90.0), Latitude(-45.0))));
    EXPECT_TRUE(
        geo_box.contains(GeoCoordinate2d(Longitude(-90.0), Latitude(-45.0))));
    ...
    EXPECT_FALSE(
        geo_box.contains(GeoCoordinate2d(Longitude(90.01), Latitude(45.01))));
    EXPECT_FALSE(
        geo_box.contains(GeoCoordinate2d(Longitude(90.01), Latitude(-45.01))));
    EXPECT_FALSE(
        geo_box.contains(GeoCoordinate2d(Longitude(-90.01), Latitude(-45.01))));
...

  {
    ...
    EXPECT_TRUE(
        geo_box.contains(GeoCoordinate2d(Longitude(90.0), Latitude(45.0))));
    EXPECT_TRUE(
        geo_box.contains(GeoCoordinate2d(Longitude(90.0), Latitude(0.1))));
    EXPECT_TRUE(
        geo_box.contains(GeoCoordinate2d(Longitude(0.1), Latitude(0.1))));
    EXPECT_TRUE(
        geo_box.contains(GeoCoordinate2d(Longitude(0.1), Latitude(45.0))));

    EXPECT_FALSE(
        geo_box.contains(GeoCoordinate2d(Longitude(90.01), Latitude(45.01))));
    EXPECT_FALSE(
        geo_box.contains(GeoCoordinate2d(Longitude(90.01), Latitude(0.0))));
    EXPECT_FALSE(
        geo_box.contains(GeoCoordinate2d(Longitude(0.0), Latitude(0.0))));
    EXPECT_FALSE(
        geo_box.contains(GeoCoordinate2d(Longitude(0.0), Latitude(45.01))));
  }
}
...
TEST(GEOCOORDINATEBOUNDINGBOX2D, grow_to_contain) {
  {
    ...
    geo_box.grow_to_contain(GeoCoordinate2d(Longitude(180.0), Latitude(90.0)));
...

  {
    ...
    geo_box.grow_to_contain(GeoCoordinate2d(Longitude(0.0), Latitude(0.0)));
