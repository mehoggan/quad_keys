...
struct Longitude {
 ...
 public:
  ...
  bool operator<(const Longitude &rhs) const { return m_val < rhs.m_val; }
  bool operator<=(const Longitude &rhs) const { return m_val <= rhs.m_val; }
...
struct Latitude {
 ...
 public:
  ...
  bool operator<(const Latitude &rhs) const { return m_val < rhs.m_val; }
  bool operator<=(const Latitude &rhs) const { return m_val <= rhs.m_val; }
...
class GeoCoordinate2d {
 ...
 public:
  ...
  void set_longitude(const struct Longitude &longit) { m_longitude = longit; }
  void set_latitude(const struct Latitude &latit) { m_latitude = latit; }
  ...
  inline bool operator==(const GeoCoordinate2d &rhs) const {
    return (m_longitude == rhs.m_longitude) && (m_latitude == rhs.m_latitude);
  }
