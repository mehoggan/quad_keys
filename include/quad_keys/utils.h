...
namespace quad_keys
{
  struct UInt32XYPair_t
  {
    ...
    friend bool operator==(const UInt32XYPair_t &lhs,
        const UInt32XYPair_t &rhs)
    {
  ...
  struct Int32XYPair_t
  {
    ...
    friend bool operator==(const Int32XYPair_t &lhs,
      const Int32XYPair_t &rhs)
    {
      return lhs.x == rhs.x && lhs.y == rhs.y;
    }
    friend bool operator!=(const Int32XYPair_t &lhs,
  ...
  struct DoubleXYPair_t
  {
    ...
    friend bool operator==(const DoubleXYPair_t &lhs,
      const DoubleXYPair_t &rhs)
    {
      return lhs.x == rhs.x && lhs.y == rhs.y;
    }
    friend bool operator!=(const DoubleXYPair_t &lhs,
